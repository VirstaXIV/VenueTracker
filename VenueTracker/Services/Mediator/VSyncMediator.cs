...
public sealed class VSyncMediator : IHostedService
{
    ...
    public VSyncMediator(ILogger<VSyncMediator> logger)
    {
        _logger = logger;
    }
    ...
    {
        _logger.LogInformation("Starting VSyncMediator");
        ...
        _logger.LogInformation("Started VSyncMediator");
